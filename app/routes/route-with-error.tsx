...
export function ErrorBoundary({ error }) {
  return (
    <Box bg='red.400' px={4} py={2}>
      <Heading as='h3' size='lg' color='white'>Something is really wrong!</Heading>
      <Box color='white' fontSize={22}>{error.message}</Box>
    </Box>
  )
}
...
export default function RouteWithError() {
  return (
    <Box>
      <Text>
        If you see this then you imported Text
      </Text>
    </Box>
  )
}
